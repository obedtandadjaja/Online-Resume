		...
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" method="POST" action="update_volunteers" files="true" enctype="multipart/form-data">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<div class="form-group">
								<label class="col-md-4 control-label">Organization/Company Name:</label>
								<div class="col-md-6">
		...
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<p rows="1">{{ $volunteer->name }}</p>

				</div>

                <!-- Picture -->

                @if(isset($volunteer->logo))
                <div class="panel-body">
            		<strong>Logo:</strong>
            		<br/>
            		<img src="{{ $volunteer->logo->location }}" />
                </div>
                @endif

                <div class="panel-body">
                    @if(isset($volunteer->imageUri))
                        <strong>Picture:</strong>
                        <br/>
                        @foreach ($volunteer->imageUri as $volunteer_image)
                            <img src="{{ $volunteer_image->location }}"/>
                        @endforeach
                    @endif
                </div>
				...
				<div class="panel-body">
					<strong>Role:</strong>
					<br/>
					<p class="col-md-12">{{ $volunteer->role }}</p>
				</div>
				...
				<div class="panel-body">
					<strong>Cause:</strong>
					<br/>
					<p class="col-md-12">{{ $volunteer->cause }}</p>
				</div>
				...
				<div class="panel-body">
					...
					<br/>
					<p class="col-md-12">{{ $volunteer->time_period }}</p>
				</div>
				...
				<div class="panel-body">
					...
					<br/>
					<p class="col-md-12" rows="3">{{ $volunteer->description }}</p>
				</div>

				<!-- Buttons -->
				
				<div class="panel-body">
					{!! Form::open(array('route' => array('update_volunteers.destroy', $volunteer->id), 'method' => 'delete', 'class' => 'pull-right')) !!}
						<button class="btn btn-primary">Remove</button>
					{!! Form::close() !!}
						<a href="update_volunteers/{{ $volunteer->id }}" class="pull-left">
