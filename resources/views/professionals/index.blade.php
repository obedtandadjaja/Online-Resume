		...
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" method="POST" action="update_professionals" files="true" enctype="multipart/form-data">
					...
					<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            @if(isset($professional->imageUri))
                                ...
                                <br/>
                                @foreach ($professional->imageUri as $professional_image)
                                    <img src="{{ $professional_image->location }}"/>
                                @endforeach
                            @endif
                        </div>
						...
						<div class="panel-body">
							...
							<br/>
							<p class="col-md-12">{{ $professional->position_title }}</p>
						</div>
						...
						<div class="panel-body">
							...
							<br/>
							<p class="col-md-12">{{ $professional->location }}</p>
						</div>
						...
						<div class="panel-body">
							...
							<br/>
							<p class="col-md-12">{{ $professional->time_period }}</p>
						</div>
						...
						<div class="panel-body">
							...
							<br/>
							<p class="col-md-12" rows="3">{{ $professional->description }}</p>
						</div>

						<!-- Buttons -->
						
						<div class="panel-body">
							{!! Form::open(array('route' => array('update_professionals.destroy', $professional->id), 'method' => 'delete', 'class' => 'pull-right')) !!}
								<button class="btn btn-primary">Remove</button>
							{!! Form::close() !!}
							<a href="update_professionals/{{ $professional->id }}" class="pull-left">
